...
Core node source: [goldbrix-core](https://github.com/GOLDBRIX-GBX/goldbrix-core) · Run a node: [guide](https://goldbrix.app/run-node) · Verified release binaries: [downloads](https://goldbrix.app/downloads/SHA256SUMS-v31-gbx-launchpad.txt)

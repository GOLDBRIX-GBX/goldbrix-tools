...
Core node source: [goldbrix-core](https://github.com/GOLDBRIX-GBX/goldbrix-core) · Run a node: [guide](https://goldbrix.app/run-node) · Verified release binaries: [GitHub Release](https://github.com/GOLDBRIX-GBX/goldbrix-core/releases/tag/v31-gbx-launchpad)

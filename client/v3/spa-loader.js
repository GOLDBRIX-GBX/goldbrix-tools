...
(function(){
  ...
  var MAP = {
    ...
    'my-coins':'/v3/my-coins.html', chat:'/v3/chat.html', profile:'/v3/profile-x.html',
    coin:'/v3/coin-x.html',
    ...
    'create-wallet':'/v3/create-wallet.html', 'import-wallet':'/v3/import-wallet.html', swap:'/v3/swap.html', 'buy-gbx':'/v3/swap.html', 'sell-gbx':'/v3/swap.html', 'run-node':'/v3/run-node.html', join:'/v3/join.html', protocol:'/v3/protocol.html', send:'/v3/send.html'
  };
  var PATH2ROUTE = {};

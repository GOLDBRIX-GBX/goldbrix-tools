...
(function(){
  ...
  function cfg(type){
    const C={BUY:{i:'↘',c:'#00C864',b:'rgba(0,200,100,0.12)'},SELL:{i:'↗',c:'#FF6644',b:'rgba(255,100,68,0.12)'},XFER_SENT:{i:'↗',c:'#F0A030',b:'rgba(240,160,48,0.12)'},XFER_RECEIVED:{i:'↙',c:'#3498DB',b:'rgba(52,152,219,0.12)'},GBX_SENT:{i:'↗',c:'#F0A030',b:'rgba(240,160,48,0.12)'},GBX_RECEIVED:{i:'↙',c:'#3498DB',b:'rgba(52,152,219,0.12)'},PROMOTE:{i:'★',c:'#A855F7',b:'rgba(168,85,247,0.12)'},COIN_CREATE:{i:'✦',c:'#FFD98A',b:'rgba(255,217,138,0.12)'},COIN_GRADUATE:{i:'↑',c:'#57FF9E',b:'rgba(87,255,158,0.12)'},COIN_REFUND:{i:'↩',c:'#FFD98A',b:'rgba(255,217,138,0.12)'},GBX_BUY:{i:'$',c:'#00C864',b:'rgba(0,200,100,0.12)'},GBX_SELL:{i:'$',c:'#FF6644',b:'rgba(255,100,68,0.12)'},USDC_RECEIVED:{i:'↙',c:'#3498DB',b:'rgba(52,152,219,0.12)'},CONVERT:{i:'⇄',c:'#00E5D4',b:'rgba(0,229,212,0.14)'}};
    return C[type]||{i:'•',c:'#888',b:'rgba(136,136,136,0.1)'};
  }
  function lines(a){
    const tk=a.ticker||''; let main='', sub='';
    if(a.type==='COIN_CREATE'){ main='$'+tk; sub='−'+fmtGbx(a.gbx_amount)+' GBX'; }
    else if(a.type==='COIN_GRADUATE'){ main='$'+tk; sub=t('COIN_GRADUATE'); }
    else if(a.type==='COIN_REFUND'){ main='$'+tk; sub='+'+fmtGbx(a.gbx_amount)+' GBX'; }
    else if(a.type==='BUY'){ main='$'+tk; sub='+'+fmtNum(a.coin_amount)+' '+tk+' · −'+fmtGbx(a.gbx_amount)+' GBX'; }
